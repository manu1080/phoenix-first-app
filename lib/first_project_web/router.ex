defmodule FirstProjectWeb.Router do
  ...
  import FirstProjectWeb.UserAuth
  ...
  scope "/", FirstProjectWeb do
    ...
    live_session :default, on_mount: FirstProjectWeb.UserAuthLive do
...
defmodule FirstProjectWeb.RedirectController do
  use FirstProjectWeb, :controller

  def redirect_to_guess(conn, _params) do
    render(conn, "guess.html")
  end
end
